      ...
      <div class="course_table mt-0">
        <div class="course card-header card-header-warning card-header-icon">
          @if(count($allStudents)>0)
            ...
            <form method="POST" action="{{url('/class/addstudent/toclass')}}" enctype="multipart/form-data">
          <!--<div class="table_filters">-->
             <table class="table">
               ...
               <button class="btn btn-primary btn-sm" type="submit"> Add Students to   {{DB::table('classes')->where('id' , $id)->pluck('name')->first()}} subject  </button>
