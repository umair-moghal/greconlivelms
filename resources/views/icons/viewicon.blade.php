            ...
            <tbody id="myTable">
              @foreach ($icons as $icon)
                <tr>
                  ...
                  <td class="first_row">
                    <div class="course_td icon_img_adjust">
                      <img src="{{asset('/assets/img/upload/'.$icon->image)}}" alt="" class="img-fluid">
                      <p>{{$icon->title}}</p>
                    </div>
                  </td>
                  <td class="align_ellipse first_row setting_sc_drp">
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                        <a class="dropdown-item" href="{{url('editicon/'. $icon->id)}}"><i class="fa fa-cogs"></i>Edit</a>
                        <a class="dropdown-item delete" href="javascript:void(0);" data-id="<?php echo $icon->id; ?>"> <i class="fa fa-trash"></i>Delete</a>
                      </div>
                    </li>
                  </td>
                </tr>
