            ...
            <tbody id="mybody">
              ...
              <tr>
                ...
                <?php
                  ...
                  $school = DB::table('schools')->where('sch_u_id', $schl->sch_u_id)->get()->first();
                ...
                <td class="first_row">{{$school->school_address}}</td>

                <td class="first_row"> <a href="{{url('/change/permission/school/'.$schl->sch_u_id)}}" class="btn btn-primary"> Change permissions    <i class="fa fa-unlock-alt" aria-hidden="true"></i> </a>      </td>
