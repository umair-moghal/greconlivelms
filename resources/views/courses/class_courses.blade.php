...
<!--             <div class="table_select">
          ...
          <table class="table table-hover nowrap_table_head" id="table-id">
              ...
              <tr>
               ...
               <!--  @if(auth()->user()->role_id != '5' && auth()->user()->role_id != '4')
                ...
                <td class="align_ellipse first_row">
                  ...
                  <a href="{{url('/course/showdetails/' .$course->id .'/'. $course->clas_id)}}" class="btn btn-success btn-sm"> Show Details </a>

                  <a class="btn btn-info btn-sm" href="{{url('/course/showdetails/' .$course->id .'/'. $course->clas_id)}}" target="_blank ">Course View</a>

                  <a class="btn btn-primary btn-sm" href="{{url('/show_student_attendance/'.$course->id)}}">Show attendance</a>

                  <a class="btn btn-warning btn-sm" href="{{url('/upload_syllabus/'.$course->id)}}">Syllabus</a>
