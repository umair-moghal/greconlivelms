        ...
        <div class="course card-header card-header-warning card-header-icon">
          ...
          <!--<div class="table_filters">-->
             <table class="table">
                 ...
                 <tbody>
                      <form method="POST" action="{{route('add.course.to.instructor')}}" enctype="multipart/form-data">
                       @csrf
                     @foreach($instructors as $instructor)
                      <tr>
                      <th> {{$instructor->name}} </th>
                      <th>
                      <input type="checkbox" name="instructor_id[]" value="{{$instructor->i_u_id}}"> 
                      </th>
                      </tr>
                     @endforeach
               ...
               <button class="btn btn-primary" type="submit"> Add Instructor to Course </button>
             </form>
               
          <!--</div>-->
         
         @else
            <h3>No Instructor Created Yet</h3>
          @endif
        </div>
      </div>
    </div>
