    ...
    <div class="all_courses_main">
      <div class="course_table mt-0">
          <div class="course card-header card-header-warning card-header-icon">
            <h3>Update questions for quiz</h3>
          ...
          <!--<div class="table_filters">-->
             <table class="table table-hover" id="table-id">
               ...
               <tbody id="mybody">
                    <form method="POST" action="{{url('/quiz/edit/quiz_questions/'. $id)}}" enctype="multipart/form-data">
                     @csrf
                   @foreach($questions as $index =>$q)
                    <tr>
                      ...
                      {{ in_array( $q->id, $quiz_questions) ? 'checked' : ' ' }}> 
                      </td>
                    </tr>
                   @endforeach
               </tbody>
               ...
               <button class="btn btn-primary" type="submit"> Update questions </button>
             </form>
