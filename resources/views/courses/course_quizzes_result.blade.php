      ...
      <div class="course card-header card-header-warning card-header-icon">
        ...
        @if(count($quizzes)>0)
          ...
          <table class="table table-hover" id="table-id">
            ...
            <tbody id="mybody">
              <?php 
                ...
                $overall_original_marks = 0;
                $quiz_weightage_percentage = 0;
              ?>
              ...
              <?php
                ...
                $overall_original_marks = $overall_original_marks + $original_marks;
                ...
                $OverAll_percentage = $OverAll_percentage + $quiz->percentage;
                ...
                if($quiz->percentage == 0){
                  $quiz_weightge_percentage = 0;
                }else{
                  $quiz_weightge_percentage = $qz->wait * $quiz->percentage/ 100;
                
                }
                // dd($quiz_weightage_percentage);
                $quiz_weightage_percentage = $quiz_weightage_percentage + $quiz_weightge_percentage;


                // dd($quiz->percentage);

                $grade = DB::table('grades')->where('school_id', $school_id)->where('marks_from', '<=', (int)$quiz->percentage)->where('marks_to', '>=', (int)$quiz->percentage)->get()->first(); 





                $no_of_quizzes = count($quizzes);
                $final_overall_percentage = $OverAll_percentage/$no_of_quizzes;

              // DB::table('course_students')->where('course_id', $id)->where('student_id', Auth::user()->id)->update([
              //   'overall_course_weightage' => $final_overall_percentage,
              // ]);
          ...
          <div class="result_main">
            <p>OverAll Marks: <span>{{$OverAll_marks}}</span></p>

          <p>OverAll Percentage: <span>{{$final_overall_percentage}} %</span></p>
          </div>
