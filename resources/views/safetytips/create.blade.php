              ...
              <div class="tab-pane active" id="tab_default_3">
                <div class="s_profile_fields">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="custom_input_main mobile_field">
                        <input type="text" class="form-control" name="title" value="{{old('title')}}" required minlength="3" maxlength="50" autofocus="">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="custom_input_main mobile_field">
                        <textarea class="form-control" name="description" style="height: 115px !important;" required minlength="10">{{old('description')}}</textarea>
