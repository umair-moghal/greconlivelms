          ...
          <table class="table table-hover" id="table-id">
            ...
            <thead>
              ...
              <tr>
                ...
                <th>Created On</th>
                <th scope="col">Join Live Lesson </th>
            ...
            <tbody id="mybody">
              ...
              @foreach($ass as $index =>$course)
                  <?php $course  = DB::table('ins_general_meetings')->find($course);  ?>
                  <td>{{ DB::table('users')->where('id' , $course->ins_id)->pluck('name')->first() }}</td>
                  <td>{{ date('j-F-Y  H:i:s', strtotime($course->created_at))}}</td>
                    <td>
                      <a class="btn btn-info btn-sm" href="{{ $course->join_url }}" target="_blank" >Open Live Lesson</a>
                    </td>
