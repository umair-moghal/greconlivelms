            ...
            <table class="table table-hover">
              ...
              <tbody id="mybody">
                ...
                <tr>
                  ...
                  <td class="first_row">{{$room->room_no}}</td>

                  <td class="first_row">{{$room->floor_no}}</td>
                  ...
                  <td class="align_ellipse first_row">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownProfile">
                        ...
                        <a class="dropdown-item" href="{{url('/rooms/edit/'.$room->id)}}"><i class="fa fa-cogs"></i>Edit</a>

                        <a href="javascript:void(0);" data-id="<?php echo $room->id; ?>" class="dropdown-item delete"><i class="fa fa-trash"></i>Delete</a>
