              ...
              @foreach ($departments as $department)
                <tr>
                  ...
                  <td>
                      ...
                      <a href="{{url('/departments/addclass/todepartment/'.$department->id)}}" class="btn btn-success"> View/Add subjects to <span style="color:blue">{{$department->name}}</span> department </a>
